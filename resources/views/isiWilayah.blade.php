...
<head>
  ...
  <title>Isi Wilayah - Ruang Budaya</title>
  <!-- Bootstrap CSS -->
    ...
    <div class="row">
      ...
      <div class="col-2 d-flex flex-column justify-content-between">
        <div class="ornamen ornamen-kiri">
          <img src="gambar/ornamen1.png" alt="ornamen">
        </div>
      </div>
      ...
      <div class="col-8">
        ...
        <div class="p-3 mb-1" data-nama="Tempat Wisata">
          <img src="gambar/tempat-wisata.jpeg" alt="Tempat Wisata">
        </div>
        <div class="p-3 mb-1" data-nama="Makanan Khas">
          <img src="gambar/makanan-khas.jpeg" alt="Makanan Khas">
        </div>
        <div class="p-3 mb-1" data-nama="Kesenian Tradisional">
          <img src="gambar/tari kecak.jpeg" alt="Kesenian Tradisional">
        </div>
        <div class="p-3 mb-1" data-nama="Cerita Rakyat">
          <img src="gambar/cover buku cerita sangkuriang.jpg" alt="Cerita Rakyat">
        </div>
      </div>
    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      wilayahElements.forEach((el) => {
        ...
        el.addEventListener("click", function () {
          window.location.href = namaWilayah + ".html";
        });
      });
    });
  </script>
